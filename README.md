# Erdős Distinct Distances (n=49) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Erdős Distinct Distances (n=49).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/erdos-dist-49-mathlib.git
cd erdos-dist-49-mathlib
lake exe
lake build
```
